...
from dataset import iSAID

from util1 import config
...
def get_parser():
    ...
    parser.add_argument('--local_rank', type=int, default=2, help='number of cpu threads to use during batch generation')    
