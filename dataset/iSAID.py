from .base_data import Few_Data, Base_Data
...
class iSAID_few_dataset(Few_Data):
    ...
    def __init__(self, split=0, shot=1, dataset='iSAID', mode='train', ann_type='mask', transform_dict=None,transform_tri=None):
