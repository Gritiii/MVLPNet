...
isaid_class_names = [
                 'unlabeled', 'ship', 'storage_tank', 'baseball_diamond','tennis_court','basketball_court','Ground_Track_Field','Bridge','Large_Vehicle','Small_Vehicle','Helicopter',
...
loveda_class_names = ['unlabeled', 'building', 'road', 'water','barren','forest','agriculture',]
